...
Eğer bir hata bulduysanız veya yeni bir özellik öneriniz varsa, lütfen [GitHub Issues](https://github.com/ybayraktarb/local-rag-agent/issues) sekmesini kullanarak yeni bir konu açın:

Güvenlik açığı olabilecek ayrıntılar için herkese açık issue açmayın; [güvenlik politikasındaki özel bildirim yolunu](SECURITY.md#zafiyet-bildirimi) kullanın.
